...
# Load model ResNet50 untuk fitur penampilan (appearance features)
...
aqua_model = YOLO('best_aqua_bram_1.pt').to(device)      # Model YOLOv8 untuk deteksi objek Aqua (botol)
