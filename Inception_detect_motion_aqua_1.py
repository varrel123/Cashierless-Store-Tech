...
# Transformasi untuk preprocessing gambar sebelum memasukkan ke model appearance (ukuran 299x299 untuk Inception-v3)
...
# Fungsi untuk memastikan dimensi fitur konsisten
def pad_or_truncate_features(features, target_size=2048):
            ...
            for box, conf, class_id in zip(detections, confidences, class_ids):
                if class_id == 0:  # Hanya proses class "person"
                    ...
                    if cropped_person.size > 0:
                        ...
                        with torch.no_grad():
                            feature = appearance_model(cropped_person_tensor)  # Ekstrak fitur dari Inception
